...
<html lang="en">
          ...
          <div class="tm-page-col-left">
            <div class="tm-register-container tm-mb-6">
              <div class="tm-login-container">
                <h2 class="tm-text-secondary tm-mb-6">Login</h2>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control <?php echo (!empty($username_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $username; ?>" id="username" aria-describedby="UsernameHelp" placeholder="Please enter your Username">
    <span class="invalid-feedback"><?php echo $username_err; ?></span>
  </div>
  <div class="form-group">
    <label for="password">Password</label>
    <input type="password" class="form-control <?php echo (!empty($password_err)) ? 'is-invalid' : ''; ?>" id="password" placeholder="Please enter your Password">
