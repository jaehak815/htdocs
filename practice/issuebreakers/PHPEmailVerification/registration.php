...
if(isset($_POST['submit'])){
	...
	if($check>0){
		...
		$mailHtml="Please confirm your account registration by clicking the button or link below: <br> <a href='http://192.168.1.110/practice/issuebreakers/PHPEmailVerification/check.php?id=$verification_id'><Strong>Here<Strong></a>";
